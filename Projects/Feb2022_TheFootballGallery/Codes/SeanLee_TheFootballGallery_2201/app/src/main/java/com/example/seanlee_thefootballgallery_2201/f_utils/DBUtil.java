...
//                newPost.setAuthorEmblemLeagueInt(Integer.valueOf(documentSnapshot.get("user_emblem_league").toString()));
//                newPost.setAuthorEmblemTeamInt(Integer.valueOf(documentSnapshot.get("user_emblem_team").toString()));
//                newPost.setAuthorUname(documentSnapshot.getString("user_username"));
...
//                    if(_mentionIds.get(i).length() > 0) mentionUsername = mentionUsernames.get(i);
//                    else mentionUsername = "";

//                    Comment toAdd = new Comment(_snapshot1.get(i).getString("postId"), _authors.get(i), mentionUsername, _snapshot1.get(i).getString("description"),
//                            _snapshot1.get(i).getString("parentId"), _snapshot1.get(i).getString("mentionId"));
    ...
    public static void forum_delete_like_on_comment(Context _context, String _action, Comment _comment){
        // TODO: update like
        // TODO: update ycard
    }

...
//
//        if(!_parentId.equals(_mentionId)){ // tapped comment is layer 0
//            mCurrentParentId = _parentId;
//            mCurrentMentionId = "";
...
//        mEt_comment.setTextColor(getResources().getColor(R.color.green_02, null));
//        mEt_comment.setText("@"+_tagUName + " ");
//        mEt_comment.setTextColor(getResources().getColor(R.color.gray_04, null));
